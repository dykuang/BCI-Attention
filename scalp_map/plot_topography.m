...
% from https://www.mathworks.com/matlabcentral/fileexchange/72729-topographic-eeg-meg-plot %
%   Input parameters:                                                     %
...
function h = plot_topography(ch_list, values, make_contour, system, ...
    ...
    if plot_channels, he = scatter(ch_x, ch_y, 10,'k', 'LineWidth',1.5); end
    if plot_clabels, text(ch_x+0.01, ch_y+0.01, ch_list, 'FontSize', 10); end
